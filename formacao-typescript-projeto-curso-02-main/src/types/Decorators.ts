export function ValidatDebito(targer: any, propertykey: string, descriptor: PropertyDescriptor) {
    ...
    descriptor.value = function (valorDoDebito: number) {
        ...
        if (valorDoDebito > this.saldo) {
            throw new Error("Seu saldo é insuficiente para realizar a operaçao")
        }
